...
async def chat_document(
    ...
    async def generate():
        ...
        rules = (
            ...
            "Saying 'not available in this document' is reserved for cases where the question\n"
            "asks for a SPECIFIC value or fact that genuinely is not present. For synthesis,\n"
            "refinement, predictive, or visualisation requests, never refuse with that phrase\n"
            "— follow the type-specific behaviour below.\n\n"
            ...
            "5. REFINEMENT OF PREVIOUS ANSWER\n"
